...
_Generated by `analyze_streaks.py` on 2025-09-27 18:41 (local time)_

## Yearly streak counts
Seasons with the most total streaks at or above each length, plus the current 2025 tally for context.
...
Highlights the team-seasons that spent the largest share of their schedule inside long streaks.
